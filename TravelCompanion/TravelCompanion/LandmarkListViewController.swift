...
class LandmarkListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Create Landmark instances and populate the landmarkList array
        let cnTower = Landmark(
            title: "CN Tower",
            imageName: "cn",
            description: "The CN Tower is a communication and observation tower in downtown Toronto, Ontario, Canada. " +
        ...
        landmarkList.append(cnTower)
        
        let royalOntarioMuseum = Landmark(
            title: "Royal Ontario Museum",
            imageName: "rom",
            description: "The Royal Ontario Museum (ROM) is a renowned museum of art, world culture, and natural history located in Toronto, Ontario, Canada. " +
        ...
        landmarkList.append(royalOntarioMuseum)
        
        let distilleryDistrict = Landmark(
            title: "Distillery District",
            imageName: "distillery",
            description: "The Distillery District is a historic and entertainment district located in Toronto, Ontario, Canada. " +
        ...
        landmarkList.append(distilleryDistrict)
    }
    
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showLandmarkDetails" {
            if let indexPath = tableView.indexPathForSelectedRow {
                let selectedLandmark = landmarkList[indexPath.row]
...
extension LandmarkListViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let landmark = landmarkList[indexPath.row]
        cell.titleLabel.setTitle(landmark.title, for: .normal)
        cell.titleLabel.backgroundColor = UIColor.clear
        cell.landmarkImageView.image = UIImage(named: landmark.imageName)
        return cell
    }
    
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "showLandmarkDetails", sender: self)
    }
